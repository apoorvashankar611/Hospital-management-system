          ...
          >
            <Grid sx={{ m: "auto" }} item xs={12} sm={6} md={4}>
              ...
              >
                ...
                <a
                  className="text-style"
                  href="mailto:apoorvashankar611@gmail.com"
                >
                  apoorvashankar611@gmail.com
                </a>
              </Stack>
            ...
            <Grid item xs={12} sm={4}>
              ...
              <Box sx={{ p: 2 }}>
                <NavLink className="text-style" to="/doctor" color="inherit">
                  Find a Doctor
                </NavLink>
              </Box>

              <Box sx={{ p: 2 }}>
                <NavLink className="text-style" to="/services" color="inherit">
                  All services
                </NavLink>
              </Box>
              ...
              <Box sx={{ p: 2 }}>
                <NavLink className="text-style" to="/contact" color="inherit">
                  Contact Us{" "}
                </NavLink>
              </Box>
            </Grid>
